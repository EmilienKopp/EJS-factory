    ...
    static template = {
        ...
        properties: {
            caption: {
                ...
                classes: {"image" : ["image-tool__caption"], 'quote' : ['blockquote-caption']},
                attributes: {
                    'default': [],
                }
            },
            ...
            icon: {
                tags: {'default' : 'span', 'attaches' : 'span', 'fileBlock' : 'span', 'warning': 'i'},
                classes: { 
                    'default': [], 
                    'attaches': ['file-icon'], 
        ...
        tags : {
            ...
            pre: {
                tag: 'pre',
                classes: {'default': ['ce-code__textarea'], 'code': []},
                attributes: [],
            },
            li: {
                tag: 'li',
